...
class TestHandleTweet:
    def test_pt(self, tweet):
        pt = ProcessTweet(tweet=tweet, project='project_project')
        assert pt.is_matching_project_locales()
        pt = ProcessTweet(tweet=tweet, project='project_project', project_locales=['en'])
        assert pt.is_matching_project_locales()
        pt = ProcessTweet(tweet=tweet, project='project_project', project_locales=['de'])
